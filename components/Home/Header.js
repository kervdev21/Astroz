...
function Header() {
  return (
    ...
    <div className="flex flex-col items-start w-full max-w-xl px-4 mx-auto mt-12 lg:px-8 lg:max-w-screen-xl">
    ...
    <div className="inset-y-0 right-0 w-full hidden md:visible lg:visible max-w-xl px-4 mx-auto lg:pl-8 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-1/2 lg:max-w-full lg:absolute xl:px-0">
      <img
